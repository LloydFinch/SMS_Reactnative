...
import LocationRender from './LocationInfoContainer';
            ...
            fetch(API.EVSE_LIST_URL + value.toString()).then((response)=>response.json()).then((json)=> {
                ...
                if (evselist) {
                    ...
                    evselist.map((evs)=> {
                      ...
                      evseConList.push({ Connector: evs.Connector });
                    })
                }
...
//选择EVSE
    ...
    jumpToEventLog() {
      ...
      const { location, charger, evse } = this.state;
      if (navigator) {
          navigator.push({
              id: 'Event',
              component: EventLog,
            ...
            <View style = {styles.container}>
                <View style = {styles.spineritem}>
                    ...
                    <Picker
                        ...
                        onValueChange = {(value, key) => this.selectLocation(value, key)}>
                        {
